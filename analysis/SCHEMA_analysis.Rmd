...
## Run MIRAGE on meta case control sample 
...
meta_data_mirage=data.frame(ID=meta_data$locus, gene=meta_data$hgnc_symbol, No.case=ac_ctrl_actual, No.contr=ac_ctrl_actual, group.index=group_index)
n1=24248; n2=97322 
res=mirage(meta_data_mirage, n1, n2, gamma=c(9,3,2), sigma=2)
```
