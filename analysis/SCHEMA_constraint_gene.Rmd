...
draw.triple.venn(area1=10,area2=110, area3 =32,  
                 ...
                 cat.cex = 1.3, cat.pos=0, cat.col=c("Green","Orange","Blue"), cex=1.5) # cat.cex  the size of the category names; cex: A vector (length 7) giving the size of the areas' labels; cat.pos: position of category names
#dev.off()
```
