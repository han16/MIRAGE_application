...
```{r, echo=F, message=F, warning=F}
#length(intersect(FDR_gene$Gene,as_tibble(neuro_disorers) %>% filter(Category=="ASD genes") %>% dplyr::select(`Gene name`) %>% pull()))
...
* shared genes with Schizophrenia GWAS genes genes
